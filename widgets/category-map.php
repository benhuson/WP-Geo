...
/**
 * @package    WP Geo
 * @subpackage WP Geo Category Map Widget class
 */



/**
 * @class        WP Geo Category Widget
...
class WPGeo_Category_Map_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( $wpgeo->checkGoogleAPIKey() ) {
			...
			// Start write widget
			$html_content = '';
			$map_content = $this->add_map( $width, $height, $maptype, $showpolylines, $zoom, $args['widget_id'] . '-map' );
